...
export const budgetSchema = z.object({
	title: z.string({ message: "Title must be a string" }).max(100, "Title cannot exceed 100 characters").trim().optional().or(z.literal("")),
	amount: z
	...
	startDate: z.string({ message: "Start date is required" }).min(1, "Start date is required").refine(isValidDate, "Please enter a valid date in DD/MM/YYYY format"),
