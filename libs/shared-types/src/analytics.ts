...
// Pie chart types
export const ZHorizontalBarData = z.object({
	name: z.string(),
	value: z.number(),
});
export type HorizontalBarData = z.infer<typeof ZHorizontalBarData>;

export const ZHorizontalBarChartProps = z.object({
	title: z.string(),
	description: z.string().optional(),
	data: z.array(ZHorizontalBarData),
	colors: z.array(z.string()).optional(),
	showInsights: z.boolean().optional(),
	currency: z.string().optional(),
});
export type HorizontalBarChartProps = z.infer<typeof ZHorizontalBarChartProps>;
