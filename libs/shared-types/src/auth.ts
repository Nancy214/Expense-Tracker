...
export const ZRegisterCredentials = ZUserType.pick({ email: true, name: true, password: true });
...
export const ZLoginCredentials = ZUserType.pick({ email: true, googleId: true, password: true });

export const ZAuthenticatedUser = ZUserType.omit({ password: true, googleId: true });
