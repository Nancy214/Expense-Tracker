...
export const ZChangePasswordFormDataWithRefinements = ZChangePasswordFormData.refine((data: ChangePasswordFormData) => data.newPassword === data.confirmPassword, {
...
export const ZResetPasswordSchemaWithRefinement = ZResetPasswordSchema.refine((data: ResetPasswordSchema) => data.newPassword === data.confirmPassword, {
	message: "Passwords do not match",
	path: ["confirmPassword"],
});
