...
import { format, parse, isAfter, isBefore, startOfDay, differenceInCalendarDays, parseISO } from "date-fns";
import { BillResponseType, BillStatus } from "@/types/bill";
import { getBills, deleteBill, updateBillStatus } from "@/services/bill.service";
...
const BillDataTable: React.FC<BillDataTableProps> = ({ refreshTrigger, bills: billsProp }) => {
    ...
    const getAmountDisplay = (amount: number, currency: string, toRate: number) => {
        ...
        <div className="space-y-6 p-6">
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Manage your recurring bills and payments</p>
                </div>
            ...
            {(user as any)?.settings?.billsAndBudgetsAlert !== false && billReminders.length > 0 && (
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-4">
                <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <div className="flex items-end">
                        <Button variant="outline" onClick={resetFilters} className="h-10 px-4">
                            Reset
                        </Button>
                    </div>
                </div>
                ...
                <Table>
                    <TableHeader>
                        <TableRow className="bg-gray-50 hover:bg-gray-50">
                            ...
                            <TableHead className="font-semibold text-gray-900 w-[80px]">Actions</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                            ...
                            filteredBills.map((bill) => (
                                <TableRow key={bill._id} className="hover:bg-gray-50">
                                    ...
                                    <TableCell className="font-medium text-gray-900">
                                        {getAmountDisplay(bill.amount, bill.currency || "INR", bill.toRate || 1)}
                                    </TableCell>
                                    <TableCell>
                                    ...
                                    <TableCell>{getStatusBadge(bill.billStatus, new Date(bill.dueDate))}</TableCell>
                                    <TableCell>
