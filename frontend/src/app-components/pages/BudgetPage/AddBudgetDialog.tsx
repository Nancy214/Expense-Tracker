...
const AddBudgetDialog: React.FC<AddBudgetDialogProps> = ({
    ...
    return (
        <GeneralDialog
            ...
            footerActions={
                <>
                    <Button onClick={handleSubmit}>{isEditing ? "Update Budget" : "Create Budget"}</Button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Select
                            ...
                            onValueChange={(value: BudgetFrequency) => setFormData({ ...formData, frequency: value })}
                        >
                            <SelectTrigger>
                        ...
                        <Popover>
                            <PopoverTrigger asChild>
                                ...
                                >
                                    ...
                                    {formData.startDate ? (
                                        format(parse(formData.startDate, "dd/MM/yyyy", new Date()), "dd/MM/yyyy")
                                    ) : (
