...
export const register = async (req: Request<{}, AuthResponse, RegisterCredentials>, res: Response<AuthResponse>): Promise<void> => {
	try {
...
export const login = (req: Request, res: Response, next: NextFunction): void => {
	passport.authenticate("local", { session: false }, async (err: Error | null, user: UserLocalType | UserType | false, info: { message: string }) => {
		if (err) {
...
export const refreshToken = async (req: Request<{}, RefreshTokenResponse, { refreshToken: string }>, res: Response<RefreshTokenResponse>): Promise<void> => {
	try {
...
export const forgotPassword = async (req: Request<{}, PasswordResponse, ForgotPasswordRequest>, res: Response<PasswordResponse>): Promise<void> => {
	try {
...
export const resetPassword = async (req: Request<{}, PasswordResponse, ResetPasswordRequest>, res: Response<PasswordResponse>): Promise<void> => {
	try {
