...
export const getExpenseCategoryBreakdown = async (req: Request, res: Response): Promise<void> => {
	try {
		...
		const response = await analyticsService.getExpenseCategoryBreakdown(userId, period as Period, subPeriod as string);
...
export const getBillsCategoryBreakdown = async (req: Request, res: Response): Promise<void> => {
	try {
		...
		const response = await analyticsService.getBillsCategoryBreakdown(userId, period as Period, subPeriod as string);
