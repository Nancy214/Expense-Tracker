...
import { downloadCSV, downloadExcel, generateMonthlyStatementPDF } from "@/app-components/pages/TransactionsPage/ExcelCsvPdfUtils";
...
const TransactionsPage = () => {
	...
	const handleFiltersChange = (newFilters: { categories?: string[]; types?: string[]; dateRange?: { from?: Date; to?: Date }; searchQuery?: string }) => {
					...
					<Dialog>
						...
						<DialogContent>
							...
							<div className="grid gap-4 py-4">
								...
								<Button onClick={handleExport} className="mt-2" disabled={!exportOptions.month || !exportOptions.format}>
									Export
								</Button>
							</div>
						</DialogContent>
			...
			<Card className="mb-6">
				...
				<CardContent>
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
						...
						<div className="text-center p-4 bg-muted/50 rounded-lg">
							<div className="text-2xl font-bold text-primary">{allTransactionsPagination?.total || 0}</div>
