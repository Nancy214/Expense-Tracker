                                                ...
                                                <div className="grid grid-cols-2 gap-4">
                                                            ...
                                                            <TooltipProvider>
                                                                <Tooltip>
                                                                    ...
                                                                    <TooltipContent side="top" className="max-w-xs">
                                                                        <p className="text-xs">
                                                                            When disabled, won't create the next
                                                                            transaction automatically - only sends a
                                                                            reminder.
                                                                        </p>
                                                                    </TooltipContent>
                                                                </Tooltip>
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        <Switch
                                                            ...
                                                            onCheckedChange={(checked: boolean) => {
                                                                setValue("recurringActive", checked, {
                                                                    shouldValidate: true,
                                                                });
                                                            }}
                                                        />
                                                        <div className="flex items-center gap-1">
                                                            ...
                                                            <TooltipProvider>
                                                                <Tooltip>
                                                                    ...
                                                                    <TooltipContent side="top" className="max-w-xs">
                                                                        <p className="text-xs">
                                                                            When disabled, pauses the recurring series -
