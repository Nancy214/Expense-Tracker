...
import { ArrowRight, BarChart3, Calendar, CheckCircle, PieChart, Receipt, Shield, Sparkles, Target, TrendingUp, Users, Wallet } from "lucide-react";
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex justify-between items-center h-16">
						<motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-3">
							...
							<span className="text-2xl font-bold bg-gradient-to-r from-green-700 to-slate-800 bg-clip-text text-transparent">Trauss</span>
						</motion.div>
						<motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-4">
							<Button variant="ghost" onClick={() => navigate("/login")} className="text-slate-700 hover:text-green-700 hover:bg-green-50/50">
								Sign In
							</Button>
							<Button
				...
				<div className="max-w-7xl mx-auto">
					<div className="grid lg:grid-cols-2 gap-12 items-center">
						<motion.div initial="hidden" animate="visible" variants={staggerContainer} className="space-y-8">
							...
							<motion.h1 variants={fadeInUp} className="text-5xl lg:text-6xl font-bold text-slate-900 leading-tight">
								Take Control of Your <span className="bg-gradient-to-r from-green-600 to-green-800 bg-clip-text text-transparent">Financial Future</span>
							</motion.h1>
							<motion.p variants={fadeInUp} className="text-xl text-slate-600 leading-relaxed">
								Track expenses, manage budgets, and gain valuable insights into your spending habits with Trauss — your intelligent expense tracking companion.
							</motion.p>
							<motion.div variants={fadeInUp} className="flex flex-wrap gap-4">
								...
								<Button size="lg" variant="outline" className="border-2 border-slate-300 text-slate-700 hover:bg-slate-50 text-lg px-8">
									Watch Demo
								</Button>
							</motion.div>
									...
									<CardContent className="p-8">
										<div className="space-y-6">
											<div className="flex items-center justify-between">
												<h3 className="text-lg font-semibold text-slate-700">Monthly Overview</h3>
						...
						{[
							{
								...
								description: "Effortlessly record and categorize all your income and expenses in one place",
							...
							},
							{
								...
								description: "Visualize your spending patterns with beautiful charts and insightful reports",
								gradient: "from-green-600 to-slate-600",
							},
							{
								icon: Calendar,
								title: "Calendar View",
								description: "See your financial activities on a calendar for better planning and organization",
					...
					<div className="grid lg:grid-cols-2 gap-12 items-center">
						...
						>
							<h2 className="text-4xl font-bold text-slate-900">
								Why Choose <span className="bg-gradient-to-r from-green-600 to-green-800 bg-clip-text text-transparent">Trauss</span>?
							</h2>
							<div className="space-y-6">
								{[
									{
										title: "Intuitive Interface",
										description: "Clean, modern design that makes financial management actually enjoyable",
									},
									{
									...
									},
									{
										...
										description: "Download your data in multiple formats for taxes or personal records",
									},
								].map((benefit, index) => (
									<motion.div
										key={benefit.title}
						...
						{[
							{
								...
								content: "Trauss has completely transformed how I manage my freelance income. The budget tracking features are incredible!",
								rating: 5,
							},
							{
								name: "Michael Chen",
								role: "Small Business Owner",
								content: "The analytics and reports help me understand my business expenses better. Couldn't run my business without it.",
								rating: 5,
							},
							{
								name: "Emily Rodriguez",
								role: "Graduate Student",
								content: "As a student on a tight budget, Trauss helps me stay on track with my spending. Simple and effective!",
								rating: 5,
							},
						].map((testimonial) => (
					...
					<motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
						<Card className="bg-gradient-to-br from-green-600 to-slate-700 border-none shadow-2xl overflow-hidden relative">
							<CardContent className="p-12 text-center relative z-10">
								<h2 className="text-4xl font-bold text-white mb-4">Start Your Financial Journey Today</h2>
								<p className="text-green-50 text-lg mb-8 max-w-2xl mx-auto">
									Join thousands of users who have taken control of their finances with Trauss. Get started in minutes — no credit card required.
								</p>
								<div className="flex flex-wrap justify-center gap-4">
									<Button size="lg" onClick={() => navigate("/register")} className="bg-white text-green-700 hover:bg-green-50 text-lg px-8 shadow-xl">
										Create Free Account
										<ArrowRight className="ml-2 h-5 w-5" />
									</Button>
									<Button size="lg" variant="outline" className="border-2 text-green-700 border-white hover:bg-white/10 text-lg px-8">
										Learn More
									</Button>
								</div>
							</CardContent>
				...
				<div className="max-w-7xl mx-auto">
					<div className="grid md:grid-cols-4 gap-8 mb-8">
						<div className="space-y-4">
							...
							<p className="text-sm">Your intelligent expense tracking companion for a better financial future.</p>
						</div>
						<div>
