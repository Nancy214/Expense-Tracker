...
const AddBudgetDialog: React.FC<AddBudgetDialogProps> = ({
    ...
    const categoryOptions: { value: BudgetCategoryType; label: string }[] = Object.values(BudgetCategory).map(
        (category) => ({
                                        ...
                                        <>
                                            ...
                                            <TooltipProvider>
                                                <Tooltip>
                                                    ...
                                                    <TooltipContent>
                                                        <p className="text-xs">
                                                            1 {watchedCurrency} = {(fromRate / toRate).toFixed(4)}{" "}
                                                            {user?.currency || "INR"}
                                                        </p>
                                                    </TooltipContent>
                                                </Tooltip>
