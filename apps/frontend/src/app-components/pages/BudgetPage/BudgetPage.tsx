						...
						<CardContent>
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
								...
								<div className="text-center p-4 bg-muted/50 rounded-lg">
									<div className="text-2xl font-bold text-green-600">{formatAmount(budgetProgress.savingsAchieved)}</div>
									...
									<CardHeader>
										<div className="flex justify-between items-start">
											<div>
												...
												<div className="text-md text-primary">{formatAmount(budget.amount)}</div>
												<CardDescription>
										...
										{progress && (
											<div className="space-y-2">
												...
												<div className="flex justify-between text-gray-500">
													<span className="text-sm text-primary">Spent: {formatAmount(progress.totalSpent)}</span>
													<span className="text-sm text-primary">Remaining: {formatAmount(progress.remaining)}</span>
												</div>
				...
				message={
					budgetToDelete
						? `Are you sure you want to delete the ${formatRecurrence(
							...
							)} budget of ${formatAmount(budgetToDelete.amount)} for ${budgetToDelete.category}? This action cannot be undone.`
