...
const EXPENSE_COLORS = ["#4F7FFF", "#10B981", "#F59E0B", "#8B5CF6", "#06B6D4", "#EC4899", "#F97316", "#14B8A6", "#06B6D4"];
			...
			<CardContent className="p-6">
				...
				<div className="space-y-6">
					...
					<div>
						...
						{currencies.length > 0 ? (
							<div className={`grid gap-6 ${currencies.length > 1 ? "grid-cols-1 md:grid-cols-2" : "grid-cols-1"}`}>
