        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50/30 to-slate-100">
            <div className="grid min-h-svh lg:grid-cols-2">
                ...
                <div className="relative hidden bg-gradient-to-br from-green-600/10 to-slate-700/10 lg:block">
                    <img
                        src="/e84b6b1373c00d3f1bcb0283bb7ac8dc.jpg"
                    ...
                    <div className="w-full max-w-sm">
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex items-center justify-center gap-3 mb-2">
                                ...
                                <span className="text-3xl font-bold bg-gradient-to-r from-green-700 to-slate-800 bg-clip-text text-transparent">
                                    Trauss
                                </span>
                            </div>
                            ...
                            <Card className="border-slate-200/50 shadow-2xl bg-white/80 backdrop-blur-sm">
                                ...
                                <CardContent>
                                    {error && (
                                        <div className="mb-4 p-3 text-sm text-red-700 bg-red-50 border border-red-200/50 rounded-lg">
                                            {error}
                                        </div>
                                    )}
                                    <FormProvider {...form}>
