							...
							<CardContent className="flex-1 p-4 min-h-0">
								<div className="space-y-4">
									{getVisibleExpenseCategories().length > 0 && (
										<div>
											<h3 className="text-sm font-semibold mb-3 text-gray-700">Expense Categories</h3>
											<div className="space-y-2">
												{getVisibleExpenseCategories().map(([category, color]: [string, string]) => (
									...
									{getVisibleIncomeCategories().length > 0 && (
										<div>
											<h3 className="text-sm font-semibold mb-3 text-gray-700">Income Categories</h3>
											<div className="space-y-2">
												{getVisibleIncomeCategories().map(([category, color]: [string, string]) => (
													<div key={category} className="flex items-center gap-2">
														<div
															className="w-3 h-3 rounded-full"
															style={{
									...
									{visibleCategories.size === 0 && <div className="text-center text-gray-500 text-sm py-4">No events in current view</div>}
								</div>
							</CardContent>
						</Card>
					</div>
