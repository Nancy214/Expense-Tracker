...
const OnboardingContainer = () => {
	...
	const [budgetFormData, setBudgetFormData] = useState<any>(null);
	const [expenseFormData, setExpenseFormData] = useState<any>(null);
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50/30 to-slate-100 flex items-center justify-center p-4">
			<div className="w-full max-w-3xl">
				...
				{/* Step Content */}
				<div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-200/50 p-4 md:p-6">
					...
					{currentStep === 3 && (
						<Step3FirstBudget
							onNext={handleNext}
							onBack={handleBack}
							onBudgetCreated={setBudgetData}
							initialFormData={budgetFormData}
							onFormDataChange={setBudgetFormData}
							existingBudget={budgetData}
						/>
					)}
					{currentStep === 4 && (
						<Step4FirstExpense onNext={handleNext} onBack={handleBack} budget={budgetData} initialFormData={expenseFormData} onFormDataChange={setExpenseFormData} />
					)}
