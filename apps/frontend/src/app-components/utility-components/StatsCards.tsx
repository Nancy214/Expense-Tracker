		...
		return (
			<div className="space-y-1">
				{currencies.map((currency) => {
					...
					const colorClass = type === "net" ? (amount >= 0 ? "text-blue-900" : "text-red-900") : "";
					return (
	...
	return (
		<div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
			<Card className="border-0 shadow-sm bg-gradient-to-br from-green-50 to-green-100">
				...
				<CardContent>
					<div className="text-green-900">{renderMultiCurrencyAmount("income")}</div>
			...
			<Card className="border-0 shadow-sm bg-gradient-to-br from-red-50 to-red-100">
				...
				<CardContent>
					<div className="text-red-900">{renderMultiCurrencyAmount("expense")}</div>
			...
			<Card className="border-0 shadow-sm bg-gradient-to-br from-blue-50 to-blue-100">
				...
				<CardContent>
					<div>{renderMultiCurrencyAmount("net")}</div>
