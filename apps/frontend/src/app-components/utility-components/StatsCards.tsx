	...
	return (
		<div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
			<Card className="border-0 shadow-sm bg-gradient-to-br from-green-50 to-green-100">
				...
				<CardContent>
					<div className="text-lg sm:text-xl xl:text-2xl font-bold text-green-900">{formatAmount(stats?.totalIncome || 0)}</div>
			...
			<Card className="border-0 shadow-sm bg-gradient-to-br from-red-50 to-red-100">
				...
				<CardContent>
					<div className="text-lg sm:text-xl xl:text-2xl font-bold text-red-900">{formatAmount(stats?.totalExpenses || 0)}</div>
			...
			<Card className="border-0 shadow-sm bg-gradient-to-br from-blue-50 to-blue-100">
				...
				<CardContent>
					<div className={`text-lg sm:text-xl xl:text-2xl font-bold ${stats?.balance && stats?.balance >= 0 ? "text-blue-900" : "text-red-900"}`}>
			...
			<Card className="border-0 shadow-sm bg-gradient-to-br from-purple-50 to-purple-100">
				...
				<CardContent>
					<div className="text-lg sm:text-xl xl:text-2xl font-bold text-purple-900">{stats?.activeBudgetsCount}</div>
